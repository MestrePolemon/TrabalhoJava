...
public class ConsolesController {
    ...
    public void adicionarConsole(int id, int quantidade){
        Consoles console = buscarConsole(id);
        console.adicionarProduto(quantidade);
    }

    public void removerConsole(int id, int quantidade){
        Consoles console = buscarConsole(id);
        console.removerProduto(quantidade);
    }
}
