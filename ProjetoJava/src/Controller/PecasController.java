...
public class PecasController {
    ...
    public void adicionarPeca(int id, int quantidade){
        Pecas peca = buscarPeca(id);
        peca.adicionarProduto(quantidade);
    }

    public void removerPeca(int id, int quantidade){
        Pecas peca = buscarPeca(id);
        peca.removerProduto(quantidade);
    }
